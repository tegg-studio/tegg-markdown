...
for (const version of ["vanilla","18","19","full"]) {
  ...
  execFileSync("npm",["exec","tsc","--","--noEmit","--strict","--module","esnext","--moduleResolution","node","--target","es2022","--lib","es2022,dom","--skipLibCheck","minimal.ts",...((version==="18"||version==="19")?["reactTypes.ts","reactHost.ts"]:version==="full"?["full.ts"]:[])],{cwd:dir,stdio:"inherit"});
