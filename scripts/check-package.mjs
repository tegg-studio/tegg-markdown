...
for (const file of ["LICENSE","COMMERCIAL-LICENSE.md","ATTRIBUTION.md","THIRD_PARTY_NOTICES.md","dist/index.js","dist/core.js","dist/style.css","dist/types/sdk.d.ts","dist/types/core.d.ts"]) {
